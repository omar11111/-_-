...
?>
        ...
        <form action="" method="POST" class="col-12 col-md-6 mx-auto contact-form ">
            ...
            <div class="row col-10 mb-3 mx-auto">
                <label for="inputEmail3" class="col-sm-6 col-form-label ">Frist Name</label>
            ...
            <div class="row col-10 mb-3 mx-auto">
                <label for="inputEmail3" class="col-sm-6 col-form-label ">Select Gender</label>
                <div class="col-sm-12 mx-auto">
            ...
            <div class="row col-10 mb-3 mx-auto">
                <label for="inputEmail3" class="col-sm-6 col-form-label ">Confirm Password</label>
                <div class="col-sm-12 mx-auto">
